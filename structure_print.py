...
excluded_dirs = {'.venv', 'old', 'structure_print', 'venv', '__pycache__', 'test_v2', 'test_v3',  'CO2EmissionForecasting', 'C02TransportCalculator', '.git', 'git'}
...
# Run the script
with open(os.path.join(current_dir, output_filename), 'w', encoding='utf-8') as output_file:
    traverse_directory(current_dir, output_file)

print(f"Directory structure and contents have been saved to '{output_filename}' in the current folder.")